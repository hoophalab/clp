...
mod api_doc {
    ...
    use super::metadata::__path_compression_job;
    use super::metadata::__path_compression_metadata;
    use super::metadata::__path_datasets;
    use super::metadata::__path_extract_stream_file;
    use super::metadata::__path_ingestion_details;
    use super::metadata::__path_list_files;
    use super::metadata::__path_query_speed;
    use super::metadata::__path_space_savings;
    use super::metadata::__path_time_range;
    use super::metadata::__path_timestamp_column_names;
